...
const DoctorNoteModal: React.FC<Props> = ({ isOpen, onClose, diagnosis, initialPatientData }) => {
  ...
  const defaultCatatan = `DIAGNOSIS TCM: ${diagnosis.patternId.toUpperCase()}
...
${diagnosis.lifestyleAdvice}`;
  ...
  const [notes, setCatatan] = useState(defaultCatatan);
        ...
        <div className="w-full md:w-[400px] bg-purple-50 p-8 overflow-y-auto border-r border-purple-100 flex flex-col gap-6 scrollbar-hide shadow-inner">
           ...
           <div className="space-y-5">
              ...
              <div className="space-y-2">
                 ...
                 <textarea className="w-full h-56 bg-white border border-purple-200 rounded-2xl px-5 py-4 text-xs text-purple-900 font-mono leading-relaxed focus:border-tcm-primary outline-none resize-none scrollbar-hide shadow-sm" value={notes} onChange={e => setCatatan(e.target.value)} />
              </div>
